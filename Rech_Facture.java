 ...
 * constructor is not invoked unless an object of type 'Rech_Facture'
 * created in the main() method.
 */
public class Rech_Facture extends Form
{
	public Rech_Facture()
	{
		super();
		...
		editNo_facture.setText("0");
			  ...
			  editHonor_2.setText("0.00");  
			  editHonor_3.setText("0.00"); 
	...
	/**
	 * Rech_Facture overrides dispose so it can clean up the
	 * component list.
	 */
	public void dispose()
	{
  ...
  try{
		...
		{   
		    ...
		    fin.setCommandText("select * from Facture where No_facture = "+editNo_facture.getText()+"");			  			
            fin.begin();
			...
			{     
				  ...
				  display.setBindings(new DataBinding[]{
							    ...
							    new DataBinding(editRef_admi,"text","Ref_admi"),
							    ...
							    new DataBinding(editHonor_2,"text","Honor_2"),
								new DataBinding(editHonor_3,"text","Honor_3"),
	...
	Label labelHonor_2 = new Label();
	Edit editRed_x = new Edit();
	Label labelHonor_3 = new Label();
	Label labelDivers = new Label();
	Edit editHonor_1 = new Edit();
	Label labelCharge_tot = new Label();
	Edit editHonor_2 = new Edit();
	Edit editHonor_3 = new Edit();
	...
	private void initForm()
	{
		...
		IResourceManager resources = new ResourceManager(this, "Rech_Facture");
		...
		panel3.setLocation(new Point(8, 128));
		panel3.setSize(new Point(584, 256));
		panel3.setTabIndex(1);
		panel3.setText("panel3");
		panel3.setBorderStyle(BorderStyle.FIXED_3D);

		edit4.setLocation(new Point(8, 176));
		...
		label1.setLocation(new Point(46, 347));
		label1.setSize(new Point(64, 20));
		label1.setTabIndex(45);
		...
		button3.setLocation(new Point(86, 213));
		...
		pictureBox5.setLocation(new Point(388, 150));
		...
		labelNo_admi.setLocation(new Point(23, 268));
		...
		editRef_admi.setLocation(new Point(103, 268));
		...
		labelRef_comp.setLocation(new Point(23, 292));
		...
		editRef_comp.setLocation(new Point(28, 316));
		editRef_comp.setSize(new Point(160, 20));
		...
		labelHonor_1.setText(" Honoraire_1");
		labelHonor_1.setBorderStyle(BorderStyle.FIXED_3D);

		labelHonor_2.setBackColor(Color.CONTROL);
		labelHonor_2.setFont(new Font("MS Sans Serif", 8.0f, FontSize.POINTS, FontWeight.BOLD, false, false, false, CharacterSet.DEFAULT, 0));
		labelHonor_2.setLocation(new Point(401, 248));
		labelHonor_2.setSize(new Point(85, 20));
		labelHonor_2.setTabIndex(39);
		labelHonor_2.setTabStop(false);
		labelHonor_2.setText(" Honoraire_2");
		labelHonor_2.setBorderStyle(BorderStyle.FIXED_3D);
		...
		editRed_x.setTabIndex(40);
		editRed_x.setText("");
		editRed_x.setTextAlign(HorizontalAlignment.RIGHT);

		labelHonor_3.setBackColor(Color.CONTROL);
		labelHonor_3.setFont(new Font("MS Sans Serif", 8.0f, FontSize.POINTS, FontWeight.BOLD, false, false, false, CharacterSet.DEFAULT, 0));
		labelHonor_3.setLocation(new Point(401, 272));
		labelHonor_3.setSize(new Point(85, 20));
		labelHonor_3.setTabIndex(41);
		labelHonor_3.setTabStop(false);
		labelHonor_3.setText(" Honoraire_3");
		labelHonor_3.setBorderStyle(BorderStyle.FIXED_3D);
		...
		labelDivers.setLocation(new Point(401, 296));
		labelDivers.setSize(new Point(85, 20));
		labelDivers.setTabIndex(43);
		...
		labelCharge_tot.setTabIndex(46);
		labelCharge_tot.setTabStop(false);
		labelCharge_tot.setText("Charge_totale");
		labelCharge_tot.setBorderStyle(BorderStyle.FIXED_3D);

		editHonor_2.setAnchor(ControlAnchor.TOPLEFTRIGHT);
		editHonor_2.setEnabled(false);
		editHonor_2.setLocation(new Point(489, 248));
		editHonor_2.setSize(new Point(93, 20));
		editHonor_2.setTabIndex(47);
		editHonor_2.setText("");
		editHonor_2.setTextAlign(HorizontalAlignment.RIGHT);

		editHonor_3.setAnchor(ControlAnchor.TOPLEFTRIGHT);
		editHonor_3.setEnabled(false);
		editHonor_3.setLocation(new Point(489, 272));
		editHonor_3.setSize(new Point(93, 20));
		editHonor_3.setTabIndex(48);
		editHonor_3.setText("");
		editHonor_3.setTextAlign(HorizontalAlignment.RIGHT);
		...
		edit1.setLocation(new Point(112, 347));
		edit1.setSize(new Point(56, 20));
		edit1.setTabIndex(49);
		edit1.setText("");
		...
		label2.setLocation(new Point(109, 3));
		label2.setSize(new Point(368, 24));
		label2.setTabIndex(52);
		label2.setTabStop(false);
		label2.setText("Recherche  d\'une  Facture");
		...
		button1.setLocation(new Point(134, 180));
		button1.setSize(new Point(40, 40));
		button1.setTabIndex(55);
		...
		label4.setLocation(new Point(400, 320));
		label4.setSize(new Point(85, 20));
		label4.setTabIndex(42);
		label4.setTabStop(false);
		label4.setText(" Sonographie");
		label4.setBorderStyle(BorderStyle.FIXED_3D);

		pictureBox3.setLocation(new Point(18, 137));
		pictureBox3.setSize(new Point(568, 240));
		pictureBox3.setTabIndex(14);
		...
		sono.setLocation(new Point(489, 320));
